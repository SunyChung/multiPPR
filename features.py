...
class PPRfeatures(object):
    def __init__(self, top_k, idx_dict, ppr_dict):
        ...
        # print('idx_values shape : ', self.idx_values.shape)  # (3516, 5, 50)
    ...
    def idx_tensor(self):
        ...
        # print('idx_tensor shape : ', idx_tensor.shape)  # torch.Size([3516, 250])
        return idx_tensor

    def scr_tensor(self):
        reshaped = self.ppr_scores.reshape(self.ppr_scores.shape[0], -1)
        scr_tensor = torch.FloatTensor(reshaped)
        # print('scr_tensor shape : ', scr_tensor.shape)  # torch.Size([3516, 250])
        return scr_tensor
...
if __name__ == '__main__':
    ...
    print('movie_matshape : ', movie_mat.shape)
