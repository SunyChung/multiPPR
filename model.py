...
class ContextualizedNN(nn.Module):
    def __init__(self, data_dir, input_dim, hidden_dim, output_dim, top_k):
        ...
        self.movie_mat = get_movie_matrix(data_dir)
        with open(data_dir + 'per_user_item.dict', 'rb') as f:
    ...
    def forward(self, user_idx, item_idx):
        feature_list = self.CFs.neighbor_embeds(target_idx=item_idx)
        ...
        per_user_items = self.per_user_item_dict[user_idx]
        item_list = []
